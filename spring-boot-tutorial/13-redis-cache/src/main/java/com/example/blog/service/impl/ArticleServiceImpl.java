...
public class ArticleServiceImpl implements ArticleService {
    ...
    public ArticleVO getDetail(Long id) {
        ...
        // 查询文章标签
        List<TagVO> tags = articleTagMapper.selectTagsByArticleId(id);
        vo.setTags(tags);
    ...
    public Long create(ArticleCreateDTO dto) {
        ...
        if (dto.getTagIds() != null && !dto.getTagIds().isEmpty()) {
            articleTagMapper.insertArticleTags(article.getId(), dto.getTagIds());
        }
    ...
    public void update(Long id, ArticleUpdateDTO dto) {
        ...
        if (dto.getTagIds() != null) {
            ...
            if (!dto.getTagIds().isEmpty()) {
                articleTagMapper.insertArticleTags(id, dto.getTagIds());
            }
        }
    }
