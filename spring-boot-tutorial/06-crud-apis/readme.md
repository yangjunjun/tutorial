...
VALUES
('Spring Boot 3 入门指南', '# Spring Boot 3\n\n这是一篇入门教程...', 'Spring Boot 3 快速上手', 1, 1, 1),
...
MapStruct 是一个编译时代码生成器，自动生成 Bean 映射代码：
...
**注意**：类上标注 `@Validated` 后，方法参数上的校验注解（如 `@Min`）才能生效。校验失败时抛出 `ConstraintViolationException`，由全局异常处理器捕获。
...
curl -X POST http://localhost:8080/api/articles \
  ...
  -d '{
    ...
    "content": "# Spring Boot 3\n\n这是一篇关于 Spring Boot 3 的入门教程，涵盖了以下内容：\n\n1. 环境搭建\n2. 项目创建\n3. 配置文件\n4. 依赖管理\n\n## 环境搭建\n\n首先需要安装 JDK 17 和 Maven 3.8+...",
    "categoryId": 1,
    "summary": "Spring Boot 3 快速上手指南",
