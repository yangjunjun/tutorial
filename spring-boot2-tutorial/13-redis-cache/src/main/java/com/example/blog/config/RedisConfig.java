 ...
 * <ul>
 *   <li>本章节代码基于 JDK 8 编译，ObjectMapper 相关 API 与 JDK 8 完全兼容</li>
 *   <li>Spring Boot 2.5.x 默认集成 Lettuce 客户端与 Spring Data Redis 2.5.x，
 *       RedisCacheManager / GenericJackson2JsonRedisSerializer 等类的用法与高版本一致</li>
 * </ul>
 *
