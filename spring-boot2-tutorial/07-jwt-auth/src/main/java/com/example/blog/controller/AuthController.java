 ...
 * <p>
 * 注意：Spring Boot 2.5 使用 javax.validation 校验注解（@Valid 来自 javax.validation），
 * 而 Spring Boot 3 使用 jakarta.validation。
 *
 * @author tutorial
 */
@RestController
        ...
        if (authentication != null && authentication.isAuthenticated()) {
            ...
            if (principal instanceof com.example.blog.security.LoginUser) {
                com.example.blog.security.LoginUser loginUser =
                        (com.example.blog.security.LoginUser) principal;
