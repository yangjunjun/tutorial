 ...
 * 2.5.12 的 spring-boot-starter-test 自带 Mockito 3.9.0 + JUnit Jupiter 5.7.2，
 * @ExtendWith(MockitoExtension.class) 的用法与 Spring Boot 3 完全一致。
 * </p>
 *
...
class ArticleServiceTest {
    ...
    class ArticleStatistics {
        ...
        void shouldIncrementViewCount() {
            ...
            assertEquals(101L, captor.getValue().getViewCount(), "浏览次数应增加 1");
        }
